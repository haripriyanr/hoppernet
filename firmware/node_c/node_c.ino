...
// Outbound Message Queue (from Serial to Node A)
struct OutboundMsg {
...
void setup() {
    ...
    delay(1000);
    Serial.println(F("=========================================="));
    Serial.println(F("  HopperNet NODE C — Destination Endpoint "));
    Serial.println(F("=========================================="));
...
// ---------------- Loop ----------------
void loop() {
    // 1. Read Commands / Return Messages from USB Serial (Local App)
    if (Serial.available()) {
